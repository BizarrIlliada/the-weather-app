export default {
  ...
  windSpeed: 'Швидкість вітру {speed} км/год',
  temperature: 'Температура повітря: {temp} °C',
  ...
  itemWasntAdded: 'Елемент не був доданий до списку!',
  itemWasntAddedToFavorite: 'Елемент не був доданий до списку обраного!',
  elementAlreadyExist: 'Такий елемент вже існує в списку.',
  listIsFull: 'Максимальна кількість елементів в списку.',
}
